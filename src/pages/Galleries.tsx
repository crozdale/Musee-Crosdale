...
const css = `
  ...
  .gl-root { background:#080808; min-height:100vh; color:#e8e0d0; }
  ...
  .gl-title { font-family:'Cinzel',serif; font-size:clamp(1.8rem,4vw,2.8rem); font-weight:400; color:#f0e8d0; letter-spacing:0.06em; margin:0 0 0.75rem; }
  .gl-subtitle { font-family:'Cormorant Garamond',serif; font-size:1rem; color:#6a6258; line-height:1.8; font-style:italic; max-width:520px; margin:0; }
  ...
  .gl-card { border:1px solid rgba(212,175,55,0.1); background:#0a0a0a; padding:1.75rem; display:flex; flex-direction:column; gap:1rem; text-decoration:none; transition:border-color .2s; }
  .gl-card:hover { border-color:rgba(212,175,55,0.3); }
  .gl-card-logo { width:48px; height:48px; border:1px solid rgba(212,175,55,0.15); background:#0c0c0c; display:flex; align-items:center; justify-content:center; font-family:'Cinzel',serif; font-size:1.1rem; color:rgba(212,175,55,0.35); flex-shrink:0; }
  .gl-card-name { font-family:'Cinzel',serif; font-size:1rem; font-weight:400; color:#f0e8d0; letter-spacing:0.06em; margin:0; transition:color .2s; }
  .gl-card:hover .gl-card-name { color:#d4af37; }
  .gl-card-blurb { font-family:'Cormorant Garamond',serif; font-size:0.88rem; color:#6a6258; line-height:1.75; font-style:italic; margin:0; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical; overflow:hidden; }
